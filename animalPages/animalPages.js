...
let keyword = (document.getElementById("random").textContent).split;

const getUrl = `${mainURL}search?&api_key=${apiKey}&q=${keyword[1]}&limit=${limitSearch}&offset=0&rating=G&lang=eng`;
fetch(getUrl)
.then(response => {
